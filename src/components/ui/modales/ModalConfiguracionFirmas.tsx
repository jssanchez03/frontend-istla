...
const ModalConfiguracionFirmas: React.FC<ModalConfiguracionFirmasProps> = ({
    ...
    const handleEliminarAutoridad = async (id: number) => {
        if (!confirm('¿Está seguro que desea eliminar esta autoridad?')) return;
            ...
            <div className="bg-white w-full h-full max-w-full rounded-none sm:w-auto sm:h-auto sm:max-w-2xl sm:rounded-lg p-0 shadow-xl max-h-[100vh] sm:max-h-[90vh] overflow-hidden flex flex-col" data-aos="zoom-in" data-aos-duration="500">
                ...
                <div className="px-4 py-3 sm:px-6 sm:py-4 border-b border-gray-200 bg-gray-50 sticky top-0 z-10 flex-shrink-0">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={onClose}
                            className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition-colors fixed top-2 right-2 sm:static sm:top-auto sm:right-auto z-20 bg-white sm:bg-transparent"
                        >
                            <X className="h-5 w-5" />
                        </button>
                    </div>
                ...
                <div className="flex-1 overflow-y-auto p-3 sm:p-6 max-h-[calc(100vh-60px)] sm:max-h-[calc(90vh-120px)]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setNuevaAutoridad(prev => ({ ...prev, nombre_autoridad: e.target.value }))}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => setNuevaAutoridad(prev => ({ ...prev, cargo_autoridad: e.target.value }))}
                                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                    <input
                                                        ...
                                                        onChange={(e) => setEditandoAutoridad(prev =>
                                                            prev ? { ...prev, nombre_autoridad: e.target.value } : null
                                                        )}
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => setEditandoAutoridad(prev =>
                                                            prev ? { ...prev, cargo_autoridad: e.target.value } : null
                                                        )}
                                                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                                        placeholder="Cargo"
                                                    />
                    ...
                    {/* Mensaje informativo */}
                    <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md flex items-start gap-3">
