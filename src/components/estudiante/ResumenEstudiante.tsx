...
const ResumenEstudiante = () => {
  ...
  useEffect(() => {
    const cargarEvaluaciones = async () => {
      ...
      try {
        ...
        const mapeadas: Evaluacion[] = data.map((ev: any) => ({
          id: ev.id_evaluacion,
          docente: ev.nombres_docente,
  ...
  const evaluacionesFiltradas = evaluaciones.filter((ev) =>
    `${ev.docente} ${ev.asignatura}`.toLowerCase().includes(busqueda.toLowerCase())
  );
    ...
    <div className="max-w-8xl mx-auto px-2 sm:px-4 py-4">
      <div className="flex items-center justify-between mb-6" data-aos="fade-right">
        ...
        <button
          ...
          title="Información sobre evaluaciones de estudiantes"
        >
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden" data-aos="fade-up">
        ...
        <div className="bg-[#189cbf] text-white p-4 rounded-t-lg" data-aos="fade-down" data-aos-delay="100">
          ...
          <p className="text-sm mt-1">Revisa el estado de tus evaluaciones docentes y completa las pendientes</p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-4 mb-4">
            {/* Tarjeta 1: Progreso */}
            <div className="bg-white rounded-md shadow-sm p-2 sm:p-4" data-aos="fade-up" data-aos-delay="300">
            ...
            {/* Tarjeta 2: Promedio */}
            <div className="bg-white rounded-md shadow-sm p-2 sm:p-4" data-aos="fade-up" data-aos-delay="400">
            ...
            <div className="bg-white rounded-md shadow-sm p-2 sm:p-4" data-aos="fade-up" data-aos-delay="500">
          ...
          <div className="bg-white rounded-md shadow-sm p-3 sm:p-4 mb-4" data-aos="fade-up" data-aos-delay="600">
            <div className="block sm:flex sm:justify-between sm:items-center mb-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">Materias y docentes del periodo {periodos.find(p => p.id_periodo === periodo)?.descripcion || ''}</p>
              </div>
          ...
          {pendientes > 0 && (
            ...
            >
              ...
              <span>
                Tienes {pendientes} evaluaciones pendientes por completar. Por favor, completa todas tus evaluaciones antes del final del periodo para contribuir a la mejora continua de la calidad educativa.
              </span>
            </div>
          )}
        </div>
      ...
      {showModal && evaluacionDetalle && (
        <div className="fixed inset-0 bg-gray-500/50 backdrop-blur-sm flex items-center justify-center z-50">
          ...
          >
                  ...
                  <div data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p className="text-sm text-gray-800 bg-gray-50 p-3 rounded-md mt-1">
                      {evaluacionDetalle.calificacion >= 80
                        ...
                        : evaluacionDetalle.calificacion >= 60
            ...
            <div className="flex justify-end" data-aos="fade-up" data-aos-delay="350">
              <button
                onClick={closeModal}
          ...
          >
            <div className="p-6 max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">
                    Información sobre Evaluaciones de Estudiantes
                  </h3>
                </div>
                <button
                  onClick={() => setMostrarInfo(false)}
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-3">¿Qué son las Heteroevaluaciones?</h4>
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h5 className="font-medium text-blue-900 mb-1">Heteroevaluación</h5>
                        <p className="text-blue-800 text-sm">
                          Evaluación que realizas sobre el desempeño de tus docentes. Tu opinión como estudiante es fundamental para el proceso de mejora continua de la calidad educativa y el desarrollo profesional de los docentes.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3 p-4 bg-orange-50 rounded-lg border border-orange-100">
                      ...
                      <div>
                        ...
                        <p className="text-orange-800 text-sm">
                          Evaluación que aún no has completado. Es importante completarla antes de la fecha límite del periodo para contribuir al proceso de evaluación.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg border border-green-100">
                      ...
                      <div>
                        ...
                        <p className="text-green-800 text-sm">
                          Evaluación que ya has finalizado. Tu calificación contribuye al proceso de evaluación institucional y ayuda a mejorar la calidad educativa.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <ul className="text-sm text-gray-600 space-y-1">
                    ...
                    <li>• Tu participación contribuye al desarrollo profesional de los docentes</li>
