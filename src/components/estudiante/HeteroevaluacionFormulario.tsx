...
import { CheckCircle, ArrowLeft, CircleHelp, GraduationCap, Info, X } from "lucide-react"
...
interface EvaluacionInfo {
    ...
    // Información del docente a evaluar (vendrá del backend)
    docente_evaluado?: {
...
const HeteroevaluacionFormulario = () => {
    ...
    useEffect(() => {
        ...
        const cargarDatos = async () => {
            try {
                ...
                // Cargar información de la evaluación (ahora incluirá info del docente si es heteroevaluación)
                const resEval = await axios.get(url, {
                    headers: { Authorization: `Bearer ${token}` }
                });

                setEvaluacionInfo(resEval.data);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const idDistributivo = evaluacionInfo?.docente_evaluado?.id_distributivo ||
                parseInt(idDistributivoFromUrl || "0");
            ...
            // Formatear las respuestas para el backend
            ...
            setTimeout(() => navigate("/estudiante"), 1200);
        } catch (err) {
    ...
    // Función para obtener el número de pregunta correcto basado en la sección
        ...
        <div className="max-w-8xl mx-auto px-2 sm:px-4 py-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2">
                <div className="flex items-center">
                    ...
                    <h1 className="text-xl text-gray-800 font-medium">Heteroevaluación Docente</h1>
                </div>
                <button
                    onClick={() => setMostrarInfo(true)}
                    className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2 bg-blue-100 hover:bg-blue-200 text-[#189cbf] rounded-lg transition-colors w-full sm:w-auto"
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="bg-[#189cbf] text-white p-3 sm:p-4 rounded-t-lg">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-xl font-medium">Formulario de Heteroevaluación</h2>
                        <CircleHelp className="h-4 w-4 ml-2" />
                    </div>
                    <p className="text-white/90 text-sm mt-1">
                        Evalúe el desempeño del docente desde su perspectiva como estudiante. Su opinión es importante para mejorar la calidad educativa.
                    </p>
                </div>

                {/* Información del docente a evaluar */}
                {(evaluacionInfo?.docente_evaluado || idDistributivoFromUrl) && (
                    <div className="p-3 sm:p-6 bg-gray-50 border-b">
                        <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2">Docente a Evaluar</h3>
                        <div className="bg-white p-3 sm:p-4 rounded-lg border">
                            <div className="flex items-center">
                                <GraduationCap className="h-5 w-5 text-[#189cbf] mr-2" />
                                <div>
                                    <p className="font-medium text-gray-900">
                                        {evaluacionInfo?.docente_evaluado?.nombre || "Docente Seleccionado"}
                                    </p>
                                    {evaluacionInfo?.docente_evaluado?.asignatura && (
                ...
                <div className="mb-4 sm:mb-6 ml-3 sm:ml-6 mt-4 sm:mt-6">
                    <p className="text-xs sm:text-sm font-medium mb-2 text-gray-700 px-2 sm:px-0">
                        <b>Instrucciones: </b>A continuación, se presentan varios indicadores. Marque de 1-5 en la casilla que coincida con su criterio
                    </p>
                            ...
                            <div className="space-y-6">
                                        ...
                                        <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blue-800 text-sm">
                                                    Preguntas divididas en secciones: Ser, Saber y Hacer para evaluar diferentes aspectos del docente.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-1">
                                        ...
                                        <li>• Selecciona la calificación que mejor refleje tu experiencia</li>
...
export default HeteroevaluacionFormulario;