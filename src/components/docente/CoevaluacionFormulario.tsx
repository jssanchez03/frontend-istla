...
import { CheckCircle, ArrowLeft, CircleHelp, Users, Info, X } from "lucide-react"
...
const CoevaluacionFormulario = () => {
    ...
    useEffect(() => {
        ...
        const cargarDatos = async () => {
            try {
                ...
                // Cargar información de la evaluación (ahora incluirá info del docente si es coevaluación)
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            toast.success("¡Coevaluación enviada con éxito!");
    ...
    if (error) return (
        <div className="bg-red-50 border border-red-200 text-[#189cbf] p-6 rounded-md">
            <p>{error}</p>
        </div>
    );
        ...
        <div className="max-w-8xl mx-auto px-2 sm:px-4 py-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 gap-2">
                <div className="flex items-center">
                    ...
                    <h1 className="text-xl text-gray-800 font-medium">Coevaluación Docente</h1>
                </div>
                <button
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="bg-[#189cbf] text-white p-3 sm:p-4 rounded-t-lg">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-xl font-medium">Formulario de Coevaluación</h2>
                        <CircleHelp className="h-4 w-4 ml-2" />
                    </div>
                    <p className="text-white/90 text-sm mt-1">
                        Evalúe el desempeño de su colega docente desde su perspectiva profesional. Su opinión contribuye al desarrollo académico mutuo.
                    </p>
                </div>
                ...
                {(evaluacionInfo?.docente_evaluado || idDistributivoFromUrl) && (
                    <div className="p-3 sm:p-6 bg-gray-50 border-b">
                        ...
                        <div className="bg-white p-3 sm:p-4 rounded-lg border">
                            <div className="flex items-center">
                                <Users className="h-5 w-5 text-[#189cbf] mr-2" />
                                <div>
                            ...
                            <div className="space-y-6">
                                        ...
                                        <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blue-800 text-sm">
                                                    Preguntas divididas en secciones: Ser, Saber y Hacer para evaluar diferentes aspectos del colega docente.
                                                </p>
                                            </div>
                                        </div>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <ul className="text-sm text-gray-600 space-y-1">
                                        ...
                                        <li>• Sé objetivo y constructivo en tu evaluación</li>
...
export default CoevaluacionFormulario;