...
import AOS from "aos";
import { FileText, CheckCircle, PlayCircle, Clock, Loader2, BookOpen, Calendar, ArrowLeft, CheckCheck, Info, X } from "lucide-react";
...
interface Evaluacion {
    ...
    estado_estudiante: "pendiente" | "completada" | "activa" | "inactiva";
...
const AutoevaluacionesDocente = () => {
    ...
    const cargarEvaluaciones = async () => {
        try {
            ...
            const autoevaluaciones = response.data.filter((evaluacion: Evaluacion) => evaluacion.id_formulario === 1);
        ...
        return (
            <div className="max-w-8xl mx-auto p-6">
                <div className="flex justify-center items-center h-64">
                    <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#189cbf]"></div>
        ...
        <div className="max-w-8xl mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6" data-aos="fade-up" data-aos-delay="100">
                    <div className="flex items-center">
                        <div className="flex-shrink-0 text-[#189cbf]">
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0 text-[#189cbf]">
                            {progreso < 100 ? (
                                ...
                                <CheckCheck className="h-10 w-10  text-[#189cbf]" />
                            )}
                        </div>
                        ...
                        >
                            <div className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex-1">
                                        <div className="flex items-center mb-2">
                                            <div className="w-2 h-2 bg-[#189cbf] rounded-full mr-2"></div>
                                            <span className="text-sm font-medium text-[#189cbf]">
                                                {evalItem.nombre_formulario}
                                            </span>
                                        </div>
                                        <h4 className="text-xl font-bold text-gray-900 mb-2">
                                            {evalItem.nombres_docente || `Autoevaluación Docente`}
                                        </h4>
                                ...
                                {evalItem.estado_estudiante === "pendiente" && (
                                    <button
                                        className="w-full bg-[#189cbf] text-white px-6 py-3 rounded-lg hover:from-[#147a98] hover:to-[#105d73] transition-all duration-200 font-semibold flex items-center justify-center"
                                        onClick={() => navigate(`/evaluaciones/auto/${evalItem.id_evaluacion}`)}
                                    >
                        ...
                        <div className="p-6 max-h-[90vh] overflow-y-auto">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h3 className="text-xl font-semibold text-gray-800">
                                        Información sobre Autoevaluaciones
                                    </h3>
                                </div>
                                <button
                                    onClick={() => setMostrarInfo(false)}
                            ...
                            <div className="space-y-6">
                                        ...
                                        <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-blue-800 text-sm">
                                                    Estadísticas de tus autoevaluaciones: total, completadas, pendientes y progreso.
                                                </p>
                                            </div>
                                        </div>
                                        <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg border border-green-100">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-green-800 text-sm">
                                                    Todas tus autoevaluaciones pendientes y completadas con detalles de cada asignatura.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="p-4 bg-gray-50 rounded-lg">
                                    <h4 className="font-semibold text-gray-800 mb-2">¿Por qué es importante autoevaluarse?</h4>
                                    <p className="text-sm text-gray-600">
                                        La autoevaluación te permite reflexionar sobre tu práctica docente e identificar áreas de mejora para tu desarrollo profesional.
                                    </p>
                                </div>
                            </div>
...
export default AutoevaluacionesDocente;